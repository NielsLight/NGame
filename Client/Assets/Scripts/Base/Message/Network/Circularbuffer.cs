...
namespace NGame
{
    public class CircularBuffer: Stream
    {
		...
		public  Task ReadAsync(Stream stream)
	    {
		    ...
		    stream.BeginRead(this.First, this.FirstIndex, sendSize);
		...
		public async Task<int> WriteAsync(Stream stream)
	    {
		    ...
		    int n = await stream.BeginWrite(this.Last, this.LastIndex, size);
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
	        ...
	        {
                throw new Exception(string.Format("bufferList length < coutn, buffer length: ", buffer.Length,offset,count));
            }
